var CPU = {
    ...
    drawDecoder: function (html){
		...
		html += '<tr class="decode_row_0"><td>0000</td><td>LOAD</td></tr>';
		html += '<tr class="decode_row_9"><td>0001</td><td>STORE</td></tr>';
		html += '<tr class="decode_row_1"><td>0010</td><td>ADD</td></tr>';
		html += '<tr class="decode_row_2"><td>0011</td><td>SUB</td></tr>';
		html += '<tr class="decode_row_3"><td>0100</td><td>MPY</td></tr>';
		html += '<tr class="decode_row_5"><td>0101</td><td>DIV</td></tr>';
		html += '<tr class="decode_row_6"><td>0110</td><td>AND</td></tr>';
		html += '<tr class="decode_row_7"><td>0111</td><td>OR</td></tr>';
		html += '<tr class="decode_row_8"><td>1000</td><td>NOT</td></tr>';
		html += '<tr class="decode_row_9"><td>1001</td><td>HALT</td></tr>';
		html += '<tr class="decode_row_9"><td>1010</td><td>CMP</td></tr>';
		html += '<tr class="decode_row_9"><td>1011</td><td>JMP</td></tr>';
		html += '<tr class="decode_row_9"><td>1100</td><td>JG (if EAX > Registro)</td></tr>';
