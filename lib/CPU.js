var CPU = {
	...
	step: function(){
		...
		switch(CPU.STATE){
			case 0: 
				...
				break;
			case 1:
				setState(2, "Ciclo de captación:", "La *Unidad de Control* coloca la dirección del MAR en el *Bus de Direcciones* y luego carga el valor allí almacenado en el *Bus de Datos*.");
				$('.active').removeClass('active');
			...
			case 5:
				...
				break;				
			case 6:
				var opcode = ((CPU.REGISTERS.IR & 0xff) >> 4);
				$('.active').removeClass('active');
				$('.decode_row_' + opcode).addClass('active');
				switch(opcode) {
					case 0:
						setState(7, "Decodificación de instrucción", "*opcode 0000* ->  HALT");
						break;
						
					case 1:
						setState(8, "Decodificación de instrucción", "*opcode 0001* ->  LOAD");
						break;
						
					case 2:
						setState(9, "Decodificación de instrucción", "*opcode 0010* ->  STORE");
						break;
						
					case 3:
						setState(10, "Decodificación de instrucción", "*opcode 0011* ->  ADD");
						break;
						
					case 5:
						setState(11, "Decodificación de instrucción", "*opcode 0100* ->  SUB");
						break;
						
					case 6:
						setState(12, "Decodificación de instrucción", "*opcode 0101* ->  MPY");
						break;
						
					case 7:
						setState(13, "Decodificación de instrucción", "*opcode 0110* ->  DIV");
						break;
						
					case 8:
						setState(14, "Decodificación de instrucción", "*opcode 0111* ->  AND");
						break;
						
					case 9:
						setState(15, "Decodificación de instrucción", "*opcode 1000* ->  OR");
						break;

					case 10:
						setState(16, "Decodificación de instrucción", "*opcode 1001* ->  NOT");
						break;
						
					case 11:
						setState(17, "Decodificación de instrucción", "*opcode 1010* ->  CMP");
						break;
						
					case 12:
						setState(18, "Decodificación de instrucción", "*opcode 1011* ->  JMP");
						break;

					case 13:
						setState(19, "Decodificación de instrucción", "*opcode 1100* ->  JG");
						break;

					case 14:
						setState(20, "Decodificación de instrucción", "*opcode 1101* ->  INPUT");
						break;
						
					case 15:
						setState(21, "Decodificación de instrucción", "*opcode 1110* ->  OUTPU");
						break;
						
					case 16:
						setState(22, "Decodificación de instrucción", "*opcode 1111* ->  CLEAR");
						break;			
				}
				break;
			case 7:
    ...
    drawDecoder: function (html){
		...
		html += '<tr class="decode_row_0"><td>0000</td><td>HALT</td></tr>';
		html += '<tr class="decode_row_1"><td>0001</td><td>LOAD</td></tr>';
		html += '<tr class="decode_row_2"><td>0010</td><td>STORE</td></tr>';
		html += '<tr class="decode_row_3"><td>0011</td><td>ADD</td></tr>';
		html += '<tr class="decode_row_4"><td>0100</td><td>SUB</td></tr>';
		html += '<tr class="decode_row_5"><td>0101</td><td>MPY</td></tr>';
		html += '<tr class="decode_row_6"><td>0110</td><td>DIV</td></tr>';
		html += '<tr class="decode_row_7"><td>0111</td><td>AND</td></tr>';
		html += '<tr class="decode_row_8"><td>1000</td><td>OR</td></tr>';
		html += '<tr class="decode_row_9"><td>1001</td><td>NOT</td></tr>';
		html += '<tr class="decode_row_10"><td>1010</td><td>CMP</td></tr>';
		html += '<tr class="decode_row_11"><td>1011</td><td>JMP</td></tr>';
		html += '<tr class="decode_row_12"><td>1100</td><td>JG (if EAX > Registro)</td></tr>';
		html += '<tr class="decode_row_13"><td>1101</td><td>INPUT</td></tr>';
		html += '<tr class="decode_row_14"><td>1110</td><td>OUTPUT</td></tr>';
		html += '<tr class="decode_row_15"><td>1111</td><td>CLEAR</td></tr>';
		html += '</table></div>';
        return html
    },
